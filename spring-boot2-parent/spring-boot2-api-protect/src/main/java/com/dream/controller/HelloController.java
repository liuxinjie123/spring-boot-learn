...
import com.dream.dto.Person;
import com.dream.util.BaseResponse;
import com.dream.util.sign.SignUtil;
import com.dream.util.ConstantUtils;
...
//		System.out.println("sIp=" + sIp);
		...
		String serverSign = SignUtil.signByMD5(params, ConstantUtils.API_SECRET_KEY);
